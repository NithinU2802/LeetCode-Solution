...
edges, where each edges[i] = [ui, vi] denotes a bi-directional edge between vertex
ui and vertex vi. Every vertex pair is connected by at most one edge, and no vertex 
...
Input: n = 3,m=3 edges = [[0,1],[1,2],[2,0]], source = 0, destination = 2
Output: true
...
Input: n = 6,m=6 edges = [[0,1],[0,2],[3,5],[5,4],[4,3]], source = 0, destination = 5
Output: false
...
public class ValidPath
{
    ...
    public static boolean check(HashMap<Integer,List<Integer>> map,int s,int d,boolean[] visit){
        if(visit[s]==true)
            return false;
        if(s==d)
            return true;
	...
	public static void main(String[] args) {
	    ...
	    int source=x.nextInt(),destination=x.nextInt();
